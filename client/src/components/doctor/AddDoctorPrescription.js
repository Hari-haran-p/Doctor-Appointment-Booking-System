...
export const AddDoctorPrescription = ({ id, patientId, fetch_appointment_data, setPrescription }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        prescriptionRemark: "",
        doctor: {
            doctorId: (JSON.parse(sessionStorage.getItem("doctor_key"))).DoctorId,
        },
        appointment: {
            appointmentId: id,
        },
    ...
    function submitrecord(e) {
        ...
        axios
            .post("http://localhost:4000/api/prescription", formData, {
                headers: {
