...
export const EditDoctorPrescription = ({ id, patientId, fetch_appointment_data, setPrescription,prescription }) => {
console.log("thisis me", prescription);
    ...
    function submitrecord(e) {
        ...
        axios
            .put("http://localhost:4000/api/prescription", {PrescriptionId : formData.PrescriptionId, Prescription : formData.Prescription, PrescriptionRemark : formData.PrescriptionRemark}, {
                headers: {
            ...
            .then((data) => {
                ...
                toast.success('Prescription Record Updated ✔', {
                    position: "top-right",
                    autoClose: 5000,
                ...
                fetch_appointment_data(prescription.AppointmentId);
            })
            .catch((error) => {
                                        ...
                                        <div className="p-3">
                                            ...
                                            >
                                                ...
                                                <div className="col-span-2">
                                                    ...
                                                    <textarea
                                                        type="text"
                                                        value={formData.PrescriptionRemark}
                                                        onChange={(e) =>
                                                            setFormData({
                                                                ...formData,
