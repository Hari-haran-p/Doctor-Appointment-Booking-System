...
export const EditMedicalrecord = ({ AppointmentId, DoctorId, PatientId, fetch_appointment_data, row }) => {
    // console.log(id);
    ...
    const [formData, setFormData] = useState({
        ...
        MedicalRecordRemark: row.MedicalRecordRemark,
        Treatments: row.Treatments
    });
    console.log(row);
    function submitrecord(e) {
        e.preventDefault();
        axios.put('http://localhost:4000/api/medicalrecord', formData, {
            headers: {
            ...
            .then((data) => {
                ...
                setShowModal(false)
                toast.success('Record Updation Done 👩‍⚕️', {
                    position: "top-right",
                    autoClose: 5000,
                                        ...
                                        <div className="p-3">
                                            <form onSubmit={(e) => submitrecord(e)} className=" grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div >
                                                    ...
                                                    <textarea
                                                        type="text"
                                                        value={formData.MedicalRecordRemark}
                                                        onChange={(e) =>
                                                            setFormData({
                                                                ...formData,
