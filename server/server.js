...
async function syncAndAddDcotor() {
    try {
        ...
        if (!doctor) {
            // Create a new user
            const newDoctor = await doctors.create({ name: "Kavinraj K", designation: "Senior doctor", qualification: "MBBS", mobile: "9754321781", address: "Sathy, erode", status: "ACTIVE", user_id: 2 });
